...
import { faTimes, faTrashAlt, faExclamationTriangle } from "@fortawesome/free-solid-svg-icons";

const DeleteModuleModal = ({ module, onClose, onConfirm }) => {
  return (
      ...
      >
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-600 text-center">
            Esta acción eliminará permanentemente el módulo <span className="font-semibold">{module?.title}</span>.
          </p>
        </div>
        <div className="mt-6 flex justify-end space-x-4">
          ...
          <motion.button
            onClick={() => onConfirm(module.ModuleID)}
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
